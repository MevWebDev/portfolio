...
export default function Header() {
  ...
  return (
    <div
      id="header"
      className="xs:w-[80%] w-full  flex flex-col items-center mt-30 mb-72 md:my-72 gap-16 md:gap-24 "
    >
      ...
      <div>
        <p className="text-center w-[80%] md:w-[50%] mx-auto">
          ...
          poland. you can check out my github or scroll down to see my projects.
        </p>
      </div>
      <motion.div
